namespace Claro.Foundation.Extension.LimitedTextFields
{
    using System;
    using System.Web.UI;
    ...
    /// <summary>
    /// Represents a single-line text field with a configurable maximum length.
    /// </summary>
    public class SingleLineLimitedField : Text, ILimitedField
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SingleLineLimitedField"/> class.
        /// </summary>
        public SingleLineLimitedField()
            : base()
        {
        }
